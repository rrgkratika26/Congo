...
class _GenerateCodeScreenState extends State<GenerateCodeScreen> {
  ...
  void setFabricValuesFromApi(String fabricCode) {
    try {
      ...
      final typeCode = parts[2].trim();

      final selectedTypeItem = typeList.cast<dynamic>().firstWhere(
        (e) => e.code == typeCode,
        orElse: () => null,
      );

      if (selectedTypeItem != null) {
        selectedType = selectedTypeItem.code; // Dropdown value
      }
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> formFields = [
      ...
      // customDropdown(
      //   title: "Type",
      //   list: typeList.cast<FabricDropdownModel>(),
