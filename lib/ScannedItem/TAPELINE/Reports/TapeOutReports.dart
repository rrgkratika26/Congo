...
import '../modelClass/TapeOutModel.dart';


// ── Screen ───────────────────────────────────────────────────────────────────

class TapeOutReports extends StatefulWidget {
  const TapeOutReports({super.key});

  @override
  State<TapeOutReports> createState() => _TapeOutReportsState();
}

class _TapeOutReportsState extends State<TapeOutReports> {
  final _searchCtrl = TextEditingController();
  String _query = '';
  DateTime? _from;
  DateTime? _to;
  List<TapelineOutReportModel> _allReports = [];
  ...
  List<TapelineOutReportModel> get _filtered {
  ...
  double get _totalNet =>
      ReportTotalHelper.totalNetWeight(_filtered, (e) => e.issueKg);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _box("Bobbing Wt(Kg)", _totalNet.toStringAsFixed(2), C.bg),
          ...
          child: SingleChildScrollView(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                DataColumn(label: _head("Container")),
                DataColumn(label: _head("DNR")),
                DataColumn(label: _head("Width (MM)")),
                DataColumn(label: _head("Issue Kg")),
                DataColumn(label: _head("Remark")),
              ...
              rows: List.generate(data.length, (i) {
                ...
                return DataRow(
                  ...
                  cells: [
                    ...
                    DataCell(
                      _cell(
                        r.issueKg.toStringAsFixed(2),
                        color: Colors.green,
                        isBold: true,
                      ),
                    ),
                    DataCell(_cell(r.qRemark)),
                    DataCell(
                      _cell(
