...
class _WebOutStockState extends State<WebOutStock> {
  ...
  void initState() {
    ...
    _countFuture =
        DashboardService.fetchWebbingScannedOutItemsCount(getApiDate());
    _loadUnit();
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDropdown(
                      ...
                      isSmallScreen: isSmallScreen,
                      onChanged: (value) =>
                          setState(() => selectedIssueTo = value),
                    ),
  ...
  // Future<void> _refreshCount() async {
  //   setState(() {
  //     _countFuture = InStockService().getOutScannedItemsCount(getApiDate());
  //   });
  // }
