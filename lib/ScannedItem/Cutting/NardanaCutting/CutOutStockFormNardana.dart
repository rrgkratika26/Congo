...
//     _articleNoCtrl.text = p.articleNo;
//
//     _bomCtrl.text = "";
...
//
//           _articleNoCtrl.text = widget.production.articleNo;
...
//   //         _isLoadingBomComponents = false; // ✅ STOP LOADER
//   //       });
//   //
//   //       return;
//   //     }
...
//   //       // BOM
//   //       if (boms.isNotEmpty) {
//   //         final previousBom = widget.production.bomNo;
//   //
...
//   //     });
//   //
//   //     // Only call cut-size API when BOTH values exist
...
//   //     }
//   //   } catch (e) {
//   //     debugPrint("❌ BOM/Component API Error: $e");
//   //
//   //     if (!mounted) return;
//   //
//   //     setState(() {
...
//
//     try {
//       final po = widget.production.workOrderNo.trim();
//       final article = widget.production.articleNo.trim();
//       final previousBom = widget.production.bomNo.trim();
//
//       debugPrint("=================================");
//       debugPrint("PO      : $po");
//       debugPrint("ARTICLE : $article");
//       debugPrint("BOM     : $previousBom");
//       debugPrint("=================================");
//
//       // =========================================================
//       // STEP 1: Try BOM + Component API
//       // =========================================================
//
//       final data = await NaradanaApiService.getBomAndComponents(
//         po: po,
...
//       if (!mounted) return;
//
//       debugPrint("BOM COMPONENT DATA: $data");
//
//       // =========================================================
//       // STEP 2: If API returned valid BOM data
//       // =========================================================
//
//       if (data != null) {
//         final boms = List<String>.from(
//           data['bomNumbers'] ?? [],
//         );
//
//         final components = List<String>.from(
//           data['components'] ?? [],
//         );
//
//         // BOM API gave BOMs
...
//           String? selectedBom;
//
//           // First priority = BOM from previous screen
//           if (previousBom.isNotEmpty && boms.contains(previousBom)) {
...
//               _selectedComponent = components.first;
//               _componentCtrl.text = components.first;
//             } else {
//               _selectedComponent = null;
//               _componentCtrl.clear();
//             }
...
//           });
//
//           // Fetch cut size if both available
//           if (_selectedBomNo != null &&
//               _selectedBomNo!.isNotEmpty &&
//               _selectedComponent != null &&
//               _selectedComponent!.isNotEmpty) {
...
//
//       // =========================================================
//       // STEP 3: BOM not found
//       // Call Marketing/bom-list API
//       // =========================================================
//
//       debugPrint("⚠️ BOM not found from BOM/Component API");
//       debugPrint("🚀 Calling getBomLists()");
//
//       await _loadBomListFallback();
//
//     } catch (e) {
//       debugPrint("❌ BOM / Component Error: $e");
//
//       if (!mounted) return;
//
//       setState(() {
...
//   }
//
//   Future<void> _loadBomListFallback() async {
//     if (!mounted) return;
//
//     setState(() {
//       _isLoadingBomComponents = true;
...
//
//     try {
//       final bomList = await NaradanaApiService.getBomLists();
//
//       if (!mounted) return;
//
...
//       String? selectedBom;
//
//       // Previous screen BOM exists in API list
//       if (previousBom.isNotEmpty && boms.contains(previousBom)) {
//         selectedBom = previousBom;
//       }
//
...
//       });
//
//       // If previous BOM exists, automatically fetch its components
//       if (selectedBom != null && selectedBom.isNotEmpty) {
//         await _loadComponentsForBom(selectedBom);
//       }
//
//     } catch (e) {
//       debugPrint("❌ BOM List Error: $e");
//
//       if (!mounted) return;
//
//       setState(() {
...
//         _card([
//           _row([
//             _field("Article No", _articleNoCtrl, readOnly: false),
...
//         print("📦 FULL API RESPONSE 👉 ${result.rollWeight}");
//
//         final value = result.remaining.toStringAsFixed(2);
//
//         setState(() {
...
//     if (!mounted || bom.trim().isEmpty) return;
//
//     setState(() {
//       _isLoadingBomComponents = true;
//       _componentList = [];
...
//     try {
//       debugPrint("=================================");
//       debugPrint("Selected BOM: $bom");
//       debugPrint("PO: ${widget.production.workOrderNo}");
//       debugPrint("Article: ${widget.production.articleNo}");
//       debugPrint("=================================");
//
//       final data = await NaradanaApiService.getBomAndComponents(
//         po: widget.production.workOrderNo,
//         article: widget.production.articleNo,
//
//         // IMPORTANT:
//         // Add BOM parameter to your service if API supports it.
//         bom: bom,
//       );
//
//       if (!mounted) return;
...
//
//         _showSnack(
//           "No components found for BOM $bom",
//           Colors.orange,
//         );
//
//         return;
...
//       });
//
//       debugPrint("✅ Components for $bom: $_componentList");
//
//       // Fetch cut size after component is available
//       if (_selectedBomNo != null &&
//           _selectedBomNo!.isNotEmpty &&
//           _selectedComponent != null &&
//           _selectedComponent!.isNotEmpty) {
...
//
//     } catch (e) {
//       debugPrint("❌ Component API Error: $e");
//
//       if (!mounted) return;
//
//       setState(() {
