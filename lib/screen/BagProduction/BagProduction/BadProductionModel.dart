...
class BagEntryModel {
  ...
  factory BagEntryModel.fromJson(Map<String, dynamic> json) {
    ...
    return BagEntryModel(
      ...
      remainingBag: (json['remaininG_BAG'] as num?)?.toDouble() ?? 0.0,
      bagWeight: (json['baG_WEIGHT'] as num?)?.toDouble() ?? 0.0,
      // remainingBag: json['remaininG_BAG'] ?? 0.0,
