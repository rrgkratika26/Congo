...
class PrintingOutReportScreen extends StatefulWidget {
  const PrintingOutReportScreen({super.key});

  @override
  State<PrintingOutReportScreen> createState() =>
      _PrintingOutReportScreenState();
}

class _PrintingOutReportScreenState extends State<PrintingOutReportScreen> {
  ...
  DateTime? _from;
  DateTime? _to;
  List<PrintingOutReportItem> _allReports = [];
  ...
  List<PrintingOutReportItem> get _pagedData {
  ...
  List<PrintingOutReportItem> get _filtered {
    return _allReports.where((r) {
      ...
      final matchTo =
          toDate == null || (reportDate != null && !reportDate.isAfter(toDate));
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final data = await VisaSmallBagApiService().fetchPrintingOutReport(
        fromDate: _from!,
        toDate: _to!,
  ...
  Widget _table(List<PrintingOutReportItem> data) {
