...
class _LoomFormState extends State<LoomForm> {
  ...
  Future<void> _loadDropdowns({String? machine, }) async {
    ...
    try {
      ...
      setState(() {
        ...
        machineTypes = res.machineTypes
            .where((e) => e.toString().trim().isNotEmpty)
            .where((e) => e.toString().trim().isNotEmpty)
            .toSet()
            .toList();

        operators = res.operators.toSet().toList(); // ✅ IMPORTANT
                  ...
                  _buildSection(
                    ...
                    children: [
                      _row([
                        ...
                        DropdownButtonFormField<String>(
                          isExpanded: true,
                          value: supervisors.contains(selectedSupervisor)
                              ? selectedSupervisor
                              : null,
                          decoration: InputDecoration(
                  ...
                  _buildSection(
                    ...
                    children: [
                      ...
                      _row([
                        ...
                        DropdownButtonFormField<String>(
                          value: machineTypes.contains(selectedMachineType)
                              ? selectedMachineType
                              : null,
                          items: machineTypes
                              .toSet()
        ...
        Expanded(
          ...
          child: OutlinedButton.icon(
            ...
            style: OutlinedButton.styleFrom(
              padding: const EdgeInsets.symmetric(vertical: 14),
              side: const BorderSide(color: C.warning, width: 1.5),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
              ),
            ),
  ...
  Future<void> _initializeData() async {
    ...
    // initialize all remaining controllers...
