...
//     // ✅ NORMAL UNIT
//     const all = [
//       _MenuItemData(label: 'PLANNING', departmentKey: 'PLANNING', icon: Icons.next_plan_rounded),
//
...
//       _MenuItemData(
//         label: 'LEDGER',
//         departmentKey: 'LEDGER',
//         icon: Icons.grain,
//       ),
//       _MenuItemData(
//         label: 'FOLDING',
//         departmentKey: 'FOLDING',
//         icon: Icons.grain,
//       ),
//       _MenuItemData(
//         label: 'TAPELINE',
//         departmentKey: 'TAPELINE',
//         icon: Icons.grain,
//       ),
//       _MenuItemData(
//         label: 'MARKETING',
...
//           height: 4,
//           decoration: BoxDecoration(
//             gradient: const LinearGradient(colors: [C.appBar2, C.appBar3]),
...
//             Navigator.pushNamed(context, AppRoutes.rmdtransfer);
//           }
//           break;
//
//         case 'BAG':
...
//             Navigator.pushNamed(context, AppRoutes.bomReport);
//           }
//           if (action == MenuAction.Bom_List){
//             Navigator.pushNamed(context, AppRoutes.bomList);
//           }
//           if (action == MenuAction.Issue_to_QC){
//             Navigator.pushNamed(context, AppRoutes.Issue_to_QC);
//           }
//
//           break;
//
